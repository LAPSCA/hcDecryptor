#!/usr/bin/env python3
'''
Copyright (C) 2023  LAPSCA$ TEAM
#if you use my code pls mintion me : ) all love have fun with it 
...
# print a GPL notice
copyrightNotice = '''LAPSCA TEAM, Copyright (C) 2023 LAPSCA$ follow us in telegram @estkan3a \n
This program comes with ABSOLUTELY NO WARRANTY.
This is free software, and you are welcome to redistribute it under certain conditions.
''' if you use my code pls mintion me : )
